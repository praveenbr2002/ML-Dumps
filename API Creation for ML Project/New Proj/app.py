...
class FileContent(db.Model):
    ...
    ___tablename__ = 'file_content'  # You can override the default table name
...
def upload():
    ...
    return render_template('upload.html', file_name=file_name, file_type=file_type, file_date=file_date, file_render=file_render, file_id=file_id)#, file_text=file_text)#file_location=file_location,
