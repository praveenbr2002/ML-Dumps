...
class DrawingSpec:
  # Color for drawing the annotation. 
  color: Tuple[int, int, int] = BLACK_COLOR
  colorlip: Tuple[int, int, int] = PINK_COLOR
  # Thickness for drawing the annotation. Default to 1 pixels.
  thickness: int = 2
  # Circle radius. Default to 1 pixels.
  circle_radius: int = 1
  ...
  if connections:
    ...
    for connection in connections:
      ...
      if start_idx in idx_to_coordinates and end_idx in idx_to_coordinates:
        ...
        # print(start_idx*image_cols, start_idx*image_rows)
        # print(end_idx*image_cols, end_idx*image_rows)
