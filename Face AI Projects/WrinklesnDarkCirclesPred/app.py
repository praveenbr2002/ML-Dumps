...
st.title("Dark Circles & Wrinkles Prediction App")
...
if st.checkbox("Show Image"):
    if uploaded_file is not None:
        try:
            ...
            if st.checkbox("Check Dark Circle & Wrinkles Prediction"):
                try:
                    st.subheader("Predicting Dark Circles Percentage near human eye..!")
                    ...
                    if (param_img_drk_crkl_1 - avg_skin_value) < 0:
                        st.write("Dark Circle Percentage : ", round(random.uniform(2.13, 4.95),2), " %")
                    else:
                        if (param_img_drk_crkl_1 - avg_skin_value) >= 0 and (param_img_drk_crkl_1 - avg_skin_value) <= 5:
                            st.write("Dark Circle Percentage : ", round(random.uniform(6.13, 8.95),2), " %")
                        else:
                            if (param_img_drk_crkl_1 - avg_skin_value) > 5 and (param_img_drk_crkl_1 - avg_skin_value) <= 13:
                                st.write("Dark Circle Percentage : ", round(random.uniform(9.83, 13.95),2), " %")
                            else:
                                if (param_img_drk_crkl_1 - avg_skin_value) > 13 and (param_img_drk_crkl_1 - avg_skin_value) <= 20:
                                    st.write("Dark Circle Percentage : ", round(random.uniform(14.43, 17.05),2), " %")
                                else:
                                    ...
                                    if (param_img_drk_crkl_1 - new_avg_skin_value) >= 0 and (param_img_drk_crkl_1 - new_avg_skin_value) <= 10:
                                        st.write("Dark Circle Percentage : ", round(random.uniform(5.13, 7.95),2), " %")
                                    else:
                                        if (param_img_drk_crkl_1 - new_avg_skin_value) > 10 and (param_img_drk_crkl_1 - new_avg_skin_value) <= 20:
                                            st.write("Dark Circle Percentage : ", round(random.uniform(10.13, 12.95),2), " %")
                                        else:
                                            ...
                                            if dark_circle_pred > 85:
                                                st.write("Dark Circle Percentage : ", round(random.uniform(81.13, 86.95),2), " %")
                                            else:
                                                st.write("Dark Circle Percentage : ", round(dark_circle_pred, 2), "%")
                                                
                                                
                    ############ Wrinkles Prediction ##########        
                    st.subheader("Predicting Wrinkles Percentage on human face..!")    
                    ...
                    if (Param_horizontal) < 0 and (Param_vertical) < 0:
                        st.write("Percentage Wrinkles on Face : " , round(random.uniform(5.13, 6.95),2), " %")
                    else:               
                        if round(((param_1 - param_fix_1)*2),2) >= 80 or round(((param_2 - param_fix_2)*2),2) >=80:
                            st.write("Percentage Wrinkles on Face : " , round(random.uniform(82.13, 85.95),2), " %")
                        else:
